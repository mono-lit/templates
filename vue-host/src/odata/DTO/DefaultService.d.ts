...
import type { DTO_BudgetAlokasiId, DTO_BudgetAlokasiListId, DTO_BudgetLedgerId, DTO_BudgetAlokasiRemainingId, DTO_BudgetId, DTO_MasterBudgetsId, DTO_PostBudgetListId, DTO_BudgetDetailId, DTO_BudgetsId, DTO_TopUpDetailId, DTO_ReportProgramId, DtoHistoryBudgetId, DtoProgramTransferId, DtoKurangBudgetDetailsId, DtoBudgetSapViewId, DTO_BudgetMasterHistoryId, DtoKurangBudgetId, DtoKurangBudgetDetailId, DTO_PPLHId, DTO_PPLDId, DTO_RETURId, DTO_RETURDId, DTO_RETURPId, DTO_UserTypeId, DTO_FeatureId, DTO_ApprovalConfigId, DTO_ApprovalId, DTO_EstimasiVSRealisasiId, DTO_ApprovalConfigConditionId, DTO_StepApprovalId, DTO_AreaId, DTO_BookWithAuthorsId, DTO_BrandId, DTO_BudgetAlokasiDetailId, DTO_BudgetTopUpId, DTO_BudgetTopUpDetailId, DTO_BudgetTransferId, DTO_BudgetTransferDetailId, DTO_CoaId, DTO_DepartmenId, DTO_DistributorId, DTO_EmailTemplateId, DTO_EstimasiHargaBrandingId, DTO_EstimasiHargaBrandingListId, DTO_HeaderPplId, DTO_HeaderPplListId, DTO_HeaderProjekId, DTO_HeaderProjekListId, DtoProjectListId, DTO_HeaderProjekBrandId, DTO_HeaderProjekDepartemenId, DTO_JenisPplId, DTO_KodeKlaimsId, DTO_JenisPplListId, DTO_JenisProgramId, DTO_JurnalLedgerId, DTO_KategoriPplId, DTO_MasterAccountId, DTO_MasterJabatanId, DTO_MasterKaryawanId, DTO_MasterKlaimId, DTO_MasterKlaimSyaratId, DTO_MasterOrgId, DTO_MasterJobPosId, DTO_MasterJobLvlId, DTO_MasterPermId, DTO_MasterRoleId, DTO_PermissionRefId, DTO_MasterUserId, DTO_UsersAttachmentId, DTO_MasterProvinsiId, DTO_MasterKotaId, DTO_MasterKecamatanId, DTO_MasterKelurahanId, DTO_OITMId, DTO_OutletId, DTO_OutletGroupId, DTO_PengajuanFormId, DTO_PengajuanFormOutletId, DTO_PengajuanFormAttachmentId, DTO_PengajuanFormProdukId, DTO_PengajuanFormDetailId, DTO_PostBudgetId, DTO_PostBudgetProgramId, DTO_ChannelId, DTO_BudgetSapId, DTO_MasterBudgetId, DTO_PplAreaId, DTO_PplAttachmentId, DTO_PplBudgetAlokasiId, DTO_PplDetailProdukId, DTO_PplDetailsId, DTO_PplOutletId, DTO_ProdukId, DTO_ProdukCategoriId, DTO_ProvinsiId, DTO_KotaId, DTO_KecamatanId, DTO_KelurahanId, DTO_RegionId, DTO_ResiId, DTO_ResiOutletId, DTO_SalesId, DTO_SalesmanId, DTO_SettingsId, DTO_SkenarioBudgetId, DTO_SkenarioBudgetListId, DTO_TopUpBudgetId, DTO_TopUpBudgetDetailId, DTO_MasterKeyVisualId, DtoHistoryTransaksiEstimasiId, DtoHistoryTransaksiRealiasasiId, DtoHistoryTransaksiEstimasiViewId, DtoHistoryTransaksiRealiasasiViewId, DtoMasterProdukId, DTO_BudgetAlokasi, EditableDTO_BudgetAlokasi, DTO_BudgetAlokasiList, EditableDTO_BudgetAlokasiList, DTO_BudgetLedger, EditableDTO_BudgetLedger, DTO_BudgetAlokasiRemaining, EditableDTO_BudgetAlokasiRemaining, DTO_Budget, EditableDTO_Budget, DTO_MasterBudgets, EditableDTO_MasterBudgets, DTO_PostBudgetList, EditableDTO_PostBudgetList, DTO_BudgetDetail, EditableDTO_BudgetDetail, DTO_Budgets, EditableDTO_Budgets, DTO_TopUpDetail, EditableDTO_TopUpDetail, DTO_ReportProgram, EditableDTO_ReportProgram, DtoHistoryBudget, EditableDtoHistoryBudget, DtoProgramTransfer, EditableDtoProgramTransfer, DtoKurangBudgetDetails, EditableDtoKurangBudgetDetails, DtoBudgetSapView, EditableDtoBudgetSapView, DTO_BudgetMasterHistory, EditableDTO_BudgetMasterHistory, DtoKurangBudget, EditableDtoKurangBudget, DtoKurangBudgetDetail, EditableDtoKurangBudgetDetail, DTO_PPLH, EditableDTO_PPLH, DTO_PPLD, EditableDTO_PPLD, DTO_RETUR, EditableDTO_RETUR, DTO_RETURD, EditableDTO_RETURD, DTO_RETURP, EditableDTO_RETURP, DTO_UserType, EditableDTO_UserType, MasterRole, EditableMasterRole, PermissionRefId, MasterRoleId, MasterOrganization, EditableMasterOrganization, MasterOrganizationId, MasterJobPosition, EditableMasterJobPosition, MasterJobPositionId, MasterJobLevel, EditableMasterJobLevel, MasterJobLevelId, PermissionRef, EditablePermissionRef, MasterPermission, EditableMasterPermission, MasterPermissionId, Author, EditableAuthor, BookAuthor, EditableBookAuthor, AuthorId, Book, EditableBook, BookId, Approval, EditableApproval, ApprovalId, Feature, EditableFeature, FeatureId, StepApproval, EditableStepApproval, StepApprovalId, ApprovalConfigCondition, EditableApprovalConfigCondition, ApprovalConfigConditionId, ApprovalConfig, EditableApprovalConfig, ApprovalConfigId, HeaderProjek, EditableHeaderProjek, BudgetAlokasiId, HeaderProjekBrandId, HeaderProjekDepartemenId, HeaderProjekId, JenisProgram, EditableJenisProgram, KategoriPplId, JenisProgramId, KategoriPpl, EditableKategoriPpl, JenisPplId, JenisPpl, EditableJenisPpl, KodeKlaims, EditableKodeKlaims, MasterKlaimId, KodeKlaimsId, MasterKlaim, EditableMasterKlaim, MasterKlaimSyaratId, MasterKlaimSyarat, EditableMasterKlaimSyarat, Region, EditableRegion, AreaId, RegionId, Area, EditableArea, DistributorId, Distributor, EditableDistributor, Brand, EditableBrand, PostBudgetId, BrandId, PostBudget, EditablePostBudget, PostBudgetProgramId, Coa, EditableCoa, CoaId, Departmen, EditableDepartmen, DepartmenId, PostBudgetProgram, EditablePostBudgetProgram, BudgetAlokasi, EditableBudgetAlokasi, BudgetAlokasiDetailId, SkenarioBudget, EditableSkenarioBudget, SkenarioBudgetId, BudgetAlokasiDetail, EditableBudgetAlokasiDetail, MasterBudget, EditableMasterBudget, MasterBudgetId, BudgetSap, EditableBudgetSap, BudgetSapId, HeaderProjekBrand, EditableHeaderProjekBrand, HeaderProjekDepartemen, EditableHeaderProjekDepartemen, PengajuanForm, EditablePengajuanForm, PengajuanFormOutletId, PengajuanFormAttachmentId, PengajuanFormProdukId, PengajuanFormDetailId, PengajuanFormId, PengajuanFormOutlet, EditablePengajuanFormOutlet, Outlet, EditableOutlet, OutletId, OutletGroup, EditableOutletGroup, OutletGroupId, PengajuanFormAttachment, EditablePengajuanFormAttachment, PengajuanFormProduk, EditablePengajuanFormProduk, PengajuanFormDetail, EditablePengajuanFormDetail, BudgetTransfer, EditableBudgetTransfer, BudgetTransferDetailId, BudgetTransferId, BudgetTransferDetail, EditableBudgetTransferDetail, KurangBudget, EditableKurangBudget, KurangBudgetDetailId, KurangBudgetId, KurangBudgetDetail, EditableKurangBudgetDetail, MasterUser, EditableMasterUser, UserDistributorId, UserAreaId, UsersAttachmentId, UserBrandId, MasterUserId, UserDistributor, EditableUserDistributor, UserArea, EditableUserArea, UsersAttachment, EditableUsersAttachment, UserBrand, EditableUserBrand, TopUpBudget, EditableTopUpBudget, TopUpBudgetDetailId, TopUpBudgetId, TopUpBudgetDetail, EditableTopUpBudgetDetail, Channel, EditableChannel, ChannelId, EstimasiVSRealisasi, EditableEstimasiVSRealisasi, EstimasiVSRealisasiId, DTO_Feature, EditableDTO_Feature, DTO_ApprovalConfig, EditableDTO_ApprovalConfig, DTO_Approval, EditableDTO_Approval, DTO_EstimasiVSRealisasi, EditableDTO_EstimasiVSRealisasi, DTO_ApprovalConfigCondition, EditableDTO_ApprovalConfigCondition, DTO_StepApproval, EditableDTO_StepApproval, DTO_Area, EditableDTO_Area, DTO_BookWithAuthors, EditableDTO_BookWithAuthors, DTO_Brand, EditableDTO_Brand, DTO_BudgetAlokasiDetail, EditableDTO_BudgetAlokasiDetail, DTO_BudgetTopUp, EditableDTO_BudgetTopUp, DTO_BudgetTopUpDetail, EditableDTO_BudgetTopUpDetail, DTO_BudgetTransfer, EditableDTO_BudgetTransfer, DTO_BudgetTransferDetail, EditableDTO_BudgetTransferDetail, DTO_Coa, EditableDTO_Coa, DTO_Departmen, EditableDTO_Departmen, DTO_Distributor, EditableDTO_Distributor, DTO_EmailTemplate, EditableDTO_EmailTemplate, DTO_EstimasiHargaBranding, EditableDTO_EstimasiHargaBranding, DTO_EstimasiHargaBrandingList, EditableDTO_EstimasiHargaBrandingList, DTO_HeaderPpl, EditableDTO_HeaderPpl, DTO_HeaderPplList, EditableDTO_HeaderPplList, DTO_HeaderProjek, EditableDTO_HeaderProjek, DTO_HeaderProjekList, EditableDTO_HeaderProjekList, DtoProjectList, EditableDtoProjectList, DTO_HeaderProjekBrand, EditableDTO_HeaderProjekBrand, DTO_HeaderProjekDepartemen, EditableDTO_HeaderProjekDepartemen, DTO_JenisPpl, EditableDTO_JenisPpl, DTO_KodeKlaims, EditableDTO_KodeKlaims, DTO_JenisPplList, EditableDTO_JenisPplList, DTO_JenisProgram, EditableDTO_JenisProgram, DTO_JurnalLedger, EditableDTO_JurnalLedger, DTO_KategoriPpl, EditableDTO_KategoriPpl, DTO_MasterAccount, EditableDTO_MasterAccount, DTO_MasterJabatan, EditableDTO_MasterJabatan, DTO_MasterKaryawan, EditableDTO_MasterKaryawan, DTO_MasterKlaim, EditableDTO_MasterKlaim, DTO_MasterKlaimSyarat, EditableDTO_MasterKlaimSyarat, DTO_MasterOrg, EditableDTO_MasterOrg, DTO_MasterJobPos, EditableDTO_MasterJobPos, DTO_MasterJobLvl, EditableDTO_MasterJobLvl, DTO_MasterPerm, EditableDTO_MasterPerm, DTO_MasterRole, EditableDTO_MasterRole, DTO_PermissionRef, EditableDTO_PermissionRef, DTO_MasterUser, EditableDTO_MasterUser, DTO_UserAreaId, DTO_UserDistributorId, DTO_UserBrandId, DTO_UsersAttachment, EditableDTO_UsersAttachment, DTO_MasterProvinsi, EditableDTO_MasterProvinsi, DTO_MasterKota, EditableDTO_MasterKota, DTO_MasterKecamatan, EditableDTO_MasterKecamatan, DTO_MasterKelurahan, EditableDTO_MasterKelurahan, DTO_OITM, EditableDTO_OITM, DTO_Outlet, EditableDTO_Outlet, DTO_OutletGroup, EditableDTO_OutletGroup, DTO_PengajuanForm, EditableDTO_PengajuanForm, DTO_PengajuanFormOutlet, EditableDTO_PengajuanFormOutlet, DTO_PengajuanFormAttachment, EditableDTO_PengajuanFormAttachment, DTO_PengajuanFormProduk, EditableDTO_PengajuanFormProduk, DTO_PengajuanFormDetail, EditableDTO_PengajuanFormDetail, DTO_PostBudget, EditableDTO_PostBudget, DTO_PostBudgetProgram, EditableDTO_PostBudgetProgram, DTO_Channel, EditableDTO_Channel, DTO_BudgetSap, EditableDTO_BudgetSap, DTO_MasterBudget, EditableDTO_MasterBudget, DTO_PplArea, EditableDTO_PplArea, DTO_PplAttachment, EditableDTO_PplAttachment, DTO_PplBudgetAlokasi, EditableDTO_PplBudgetAlokasi, DTO_PplDetailProduk, EditableDTO_PplDetailProduk, DTO_PplDetails, EditableDTO_PplDetails, DTO_PplOutlet, EditableDTO_PplOutlet, DTO_Produk, EditableDTO_Produk, DTO_ProdukCategori, EditableDTO_ProdukCategori, DTO_Provinsi, EditableDTO_Provinsi, DTO_Kota, EditableDTO_Kota, DTO_Kecamatan, EditableDTO_Kecamatan, DTO_Kelurahan, EditableDTO_Kelurahan, DTO_Region, EditableDTO_Region, DTO_Resi, EditableDTO_Resi, DTO_ResiDetailProdukId, DTO_ResiPicId, DTO_ResiAttachmentId, DTO_ResiOutlet, EditableDTO_ResiOutlet, DTO_Sales, EditableDTO_Sales, DTO_Salesman, EditableDTO_Salesman, DTO_Settings, EditableDTO_Settings, DTO_SkenarioBudget, EditableDTO_SkenarioBudget, DTO_SkenarioBudgetList, EditableDTO_SkenarioBudgetList, DTO_TopUpBudget, EditableDTO_TopUpBudget, DTO_TopUpBudgetDetail, EditableDTO_TopUpBudgetDetail, DTO_MasterKeyVisual, EditableDTO_MasterKeyVisual, DTO_MasterOrgSlim, EditableDTO_MasterOrgSlim, DTO_MasterOrgSlimId, DTO_UserArea, EditableDTO_UserArea, DTO_UserDistributor, EditableDTO_UserDistributor, DTO_UserBrand, EditableDTO_UserBrand, DTO_ResiDetailProduk, EditableDTO_ResiDetailProduk, DTO_ResiPic, EditableDTO_ResiPic, DTO_ResiAttachment, EditableDTO_ResiAttachment, DtoHistoryTransaksiEstimasi, EditableDtoHistoryTransaksiEstimasi, DtoHistoryTransaksiRealiasasi, EditableDtoHistoryTransaksiRealiasasi, DtoHistoryTransaksiEstimasiView, EditableDtoHistoryTransaksiEstimasiView, DtoHistoryTransaksiRealiasasiView, EditableDtoHistoryTransaksiRealiasasiView, DtoMasterProduk, EditableDtoMasterProduk, UserDto, EditableUserDto, UserItem, EditableUserItem, TargetSeDto, EditableTargetSeDto, TargetItem, EditableTargetItem, SosmedDto, EditableSosmedDto, PlatformItem, EditablePlatformItem, SyaratDto, EditableSyaratDto, SyaratItem, EditableSyaratItem, STATUS_ENUM, EditableSTATUS_ENUM } from "./DefaultModel";
import type { QDTO_BudgetAlokasi, QDTO_BudgetAlokasiList, QDTO_BudgetLedger, QDTO_BudgetAlokasiRemaining, QDTO_Budget, QDTO_MasterBudgets, QDTO_PostBudgetList, QDTO_BudgetDetail, QDTO_Budgets, QDTO_TopUpDetail, QDTO_ReportProgram, QDtoHistoryBudget, QDtoProgramTransfer, QDtoKurangBudgetDetails, QDtoBudgetSapView, QDTO_BudgetMasterHistory, QDtoKurangBudget, QDtoKurangBudgetDetail, QDTO_PPLH, QDTO_PPLD, QDTO_RETUR, QDTO_RETURD, QDTO_RETURP, QDTO_UserType, QMasterRole, QMasterOrganization, QMasterJobPosition, QMasterJobLevel, QPermissionRef, QMasterPermission, QAuthor, QBookAuthor, QBook, QApproval, QFeature, QStepApproval, QApprovalConfigCondition, QApprovalConfig, QHeaderProjek, QJenisProgram, QKategoriPpl, QJenisPpl, QKodeKlaims, QMasterKlaim, QMasterKlaimSyarat, QRegion, QArea, QDistributor, QBrand, QPostBudget, QCoa, QDepartmen, QPostBudgetProgram, QBudgetAlokasi, QSkenarioBudget, QBudgetAlokasiDetail, QMasterBudget, QBudgetSap, QHeaderProjekBrand, QHeaderProjekDepartemen, QPengajuanForm, QPengajuanFormOutlet, QOutlet, QOutletGroup, QPengajuanFormAttachment, QPengajuanFormProduk, QPengajuanFormDetail, QBudgetTransfer, QBudgetTransferDetail, QKurangBudget, QKurangBudgetDetail, QMasterUser, QUserDistributor, QUserArea, QUsersAttachment, QUserBrand, QTopUpBudget, QTopUpBudgetDetail, QChannel, QEstimasiVSRealisasi, QDTO_Feature, QDTO_ApprovalConfig, QDTO_Approval, QDTO_EstimasiVSRealisasi, QDTO_ApprovalConfigCondition, QDTO_StepApproval, QDTO_Area, QDTO_BookWithAuthors, QDTO_Brand, QDTO_BudgetAlokasiDetail, QDTO_BudgetTopUp, QDTO_BudgetTopUpDetail, QDTO_BudgetTransfer, QDTO_BudgetTransferDetail, QDTO_Coa, QDTO_Departmen, QDTO_Distributor, QDTO_EmailTemplate, QDTO_EstimasiHargaBranding, QDTO_EstimasiHargaBrandingList, QDTO_HeaderPpl, QDTO_HeaderPplList, QDTO_HeaderProjek, QDTO_HeaderProjekList, QDtoProjectList, QDTO_HeaderProjekBrand, QDTO_HeaderProjekDepartemen, QDTO_JenisPpl, QDTO_KodeKlaims, QDTO_JenisPplList, QDTO_JenisProgram, QDTO_JurnalLedger, QDTO_KategoriPpl, QDTO_MasterAccount, QDTO_MasterJabatan, QDTO_MasterKaryawan, QDTO_MasterKlaim, QDTO_MasterKlaimSyarat, QDTO_MasterOrg, QDTO_MasterJobPos, QDTO_MasterJobLvl, QDTO_MasterPerm, QDTO_MasterRole, QDTO_PermissionRef, QDTO_MasterUser, QDTO_UsersAttachment, QDTO_MasterProvinsi, QDTO_MasterKota, QDTO_MasterKecamatan, QDTO_MasterKelurahan, QDTO_OITM, QDTO_Outlet, QDTO_OutletGroup, QDTO_PengajuanForm, QDTO_PengajuanFormOutlet, QDTO_PengajuanFormAttachment, QDTO_PengajuanFormProduk, QDTO_PengajuanFormDetail, QDTO_PostBudget, QDTO_PostBudgetProgram, QDTO_Channel, QDTO_BudgetSap, QDTO_MasterBudget, QDTO_PplArea, QDTO_PplAttachment, QDTO_PplBudgetAlokasi, QDTO_PplDetailProduk, QDTO_PplDetails, QDTO_PplOutlet, QDTO_Produk, QDTO_ProdukCategori, QDTO_Provinsi, QDTO_Kota, QDTO_Kecamatan, QDTO_Kelurahan, QDTO_Region, QDTO_Resi, QDTO_ResiOutlet, QDTO_Sales, QDTO_Salesman, QDTO_Settings, QDTO_SkenarioBudget, QDTO_SkenarioBudgetList, QDTO_TopUpBudget, QDTO_TopUpBudgetDetail, QDTO_MasterKeyVisual, QDTO_MasterOrgSlim, QDTO_UserArea, QDTO_UserDistributor, QDTO_UserBrand, QDTO_ResiDetailProduk, QDTO_ResiPic, QDTO_ResiAttachment, QDtoHistoryTransaksiEstimasi, QDtoHistoryTransaksiRealiasasi, QDtoHistoryTransaksiEstimasiView, QDtoHistoryTransaksiRealiasasiView, QDtoMasterProduk, QUserDto, QUserItem, QTargetSeDto, QTargetItem, QSosmedDto, QPlatformItem, QSyaratDto, QSyaratItem, QSTATUS_ENUM } from "./QDefault";
export declare class DefaultService<in out ClientType extends ODataHttpClient> extends ODataService<ClientType> {
    ...
    DTO_PostBudgetList(): DTO_PostBudgetListCollectionService<ClientType>;
    DTO_PostBudgetList(id: DTO_PostBudgetListId): DTO_PostBudgetListService<ClientType>;
    ...
    DTO_TopUpDetail(): DTO_TopUpDetailCollectionService<ClientType>;
    DTO_TopUpDetail(id: DTO_TopUpDetailId): DTO_TopUpDetailService<ClientType>;
    DTO_ReportProgram(): DTO_ReportProgramCollectionService<ClientType>;
    DTO_ReportProgram(id: DTO_ReportProgramId): DTO_ReportProgramService<ClientType>;
    DtoHistoryBudget(): DtoHistoryBudgetCollectionService<ClientType>;
    DtoHistoryBudget(id: DtoHistoryBudgetId): DtoHistoryBudgetService<ClientType>;
    DtoProgramTransfer(): DtoProgramTransferCollectionService<ClientType>;
    DtoProgramTransfer(id: DtoProgramTransferId): DtoProgramTransferService<ClientType>;
    DtoKurangBudgetDetails(): DtoKurangBudgetDetailsCollectionService<ClientType>;
    DtoKurangBudgetDetails(id: DtoKurangBudgetDetailsId): DtoKurangBudgetDetailsService<ClientType>;
    DtoBudgetSapView(): DtoBudgetSapViewCollectionService<ClientType>;
    DtoBudgetSapView(id: DtoBudgetSapViewId): DtoBudgetSapViewService<ClientType>;
    DTO_BudgetMasterHistory(): DTO_BudgetMasterHistoryCollectionService<ClientType>;
    DTO_BudgetMasterHistory(id: DTO_BudgetMasterHistoryId): DTO_BudgetMasterHistoryService<ClientType>;
    DtoKurangBudget(): DtoKurangBudgetCollectionService<ClientType>;
    DtoKurangBudget(id: DtoKurangBudgetId): DtoKurangBudgetService<ClientType>;
    DtoKurangBudgetDetail(): DtoKurangBudgetDetailCollectionService<ClientType>;
    DtoKurangBudgetDetail(id: DtoKurangBudgetDetailId): DtoKurangBudgetDetailService<ClientType>;
    ...
    DTO_EstimasiVSRealisasi(): DTO_EstimasiVSRealisasiCollectionService<ClientType>;
    DTO_EstimasiVSRealisasi(id: DTO_EstimasiVSRealisasiId): DTO_EstimasiVSRealisasiService<ClientType>;
    ...
    DtoProjectList(): DtoProjectListCollectionService<ClientType>;
    DtoProjectList(id: DtoProjectListId): DtoProjectListService<ClientType>;
    ...
    DTO_PostBudgetProgram(): DTO_PostBudgetProgramCollectionService<ClientType>;
    DTO_PostBudgetProgram(id: DTO_PostBudgetProgramId): DTO_PostBudgetProgramService<ClientType>;
    ...
    DTO_TopUpBudget(): DTO_TopUpBudgetCollectionService<ClientType>;
    DTO_TopUpBudget(id: DTO_TopUpBudgetId): DTO_TopUpBudgetService<ClientType>;
    DTO_TopUpBudgetDetail(): DTO_TopUpBudgetDetailCollectionService<ClientType>;
    DTO_TopUpBudgetDetail(id: DTO_TopUpBudgetDetailId): DTO_TopUpBudgetDetailService<ClientType>;
    ...
    DtoHistoryTransaksiEstimasiView(): DtoHistoryTransaksiEstimasiViewCollectionService<ClientType>;
    DtoHistoryTransaksiEstimasiView(id: DtoHistoryTransaksiEstimasiViewId): DtoHistoryTransaksiEstimasiViewService<ClientType>;
    DtoHistoryTransaksiRealiasasiView(): DtoHistoryTransaksiRealiasasiViewCollectionService<ClientType>;
    DtoHistoryTransaksiRealiasasiView(id: DtoHistoryTransaksiRealiasasiViewId): DtoHistoryTransaksiRealiasasiViewService<ClientType>;
    DtoMasterProduk(): DtoMasterProdukCollectionService<ClientType>;
    DtoMasterProduk(id: DtoMasterProdukId): DtoMasterProdukService<ClientType>;
}
...
export declare class DTO_BudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_Budget, EditableDTO_Budget, QDTO_Budget> {
    ...
    PostBudgetList(): DTO_PostBudgetListCollectionService<ClientType>;
    PostBudgetList(id: DTO_PostBudgetListId): DTO_PostBudgetListService<ClientType>;
}
...
export declare class DTO_MasterBudgetsService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_MasterBudgets, EditableDTO_MasterBudgets, QDTO_MasterBudgets> {
    ...
    private _JenisPplIdList?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterBudgetIdList(): CollectionServiceV4<ClientType, NumberCollection, QNumberCollection<number>, number>;
    JenisPplIdList(): CollectionServiceV4<ClientType, NumberCollection, QNumberCollection<number>, number>;
}
...
export declare class DTO_PostBudgetListService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_PostBudgetList, EditableDTO_PostBudgetList, QDTO_PostBudgetList> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_PostBudgetListCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_PostBudgetList, EditableDTO_PostBudgetList, QDTO_PostBudgetList, DTO_PostBudgetListId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class DTO_TopUpDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_TopUpDetail, EditableDTO_TopUpDetail, QDTO_TopUpDetail> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_TopUpDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_TopUpDetail, EditableDTO_TopUpDetail, QDTO_TopUpDetail, DTO_TopUpDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_ReportProgramService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_ReportProgram, EditableDTO_ReportProgram, QDTO_ReportProgram> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_ReportProgramCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_ReportProgram, EditableDTO_ReportProgram, QDTO_ReportProgram, DTO_ReportProgramId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoHistoryBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoHistoryBudget, EditableDtoHistoryBudget, QDtoHistoryBudget> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoHistoryBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoHistoryBudget, EditableDtoHistoryBudget, QDtoHistoryBudget, DtoHistoryBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoProgramTransferService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoProgramTransfer, EditableDtoProgramTransfer, QDtoProgramTransfer> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoProgramTransferCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoProgramTransfer, EditableDtoProgramTransfer, QDtoProgramTransfer, DtoProgramTransferId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoKurangBudgetDetailsService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoKurangBudgetDetails, EditableDtoKurangBudgetDetails, QDtoKurangBudgetDetails> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoKurangBudgetDetailsCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoKurangBudgetDetails, EditableDtoKurangBudgetDetails, QDtoKurangBudgetDetails, DtoKurangBudgetDetailsId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoBudgetSapViewService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoBudgetSapView, EditableDtoBudgetSapView, QDtoBudgetSapView> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoBudgetSapViewCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoBudgetSapView, EditableDtoBudgetSapView, QDtoBudgetSapView, DtoBudgetSapViewId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_BudgetMasterHistoryService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_BudgetMasterHistory, EditableDTO_BudgetMasterHistory, QDTO_BudgetMasterHistory> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_BudgetMasterHistoryCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_BudgetMasterHistory, EditableDTO_BudgetMasterHistory, QDTO_BudgetMasterHistory, DTO_BudgetMasterHistoryId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoKurangBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoKurangBudget, EditableDtoKurangBudget, QDtoKurangBudget> {
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    ...
    KurangBudgetDetail(): DtoKurangBudgetDetailCollectionService<ClientType>;
    KurangBudgetDetail(id: DtoKurangBudgetDetailId): DtoKurangBudgetDetailService<ClientType>;
}
export declare class DtoKurangBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoKurangBudget, EditableDtoKurangBudget, QDtoKurangBudget, DtoKurangBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoKurangBudgetDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoKurangBudgetDetail, EditableDtoKurangBudgetDetail, QDtoKurangBudgetDetail> {
    private _BudgetAlokasi?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    BudgetAlokasi(): DTO_BudgetAlokasiService<ClientType>;
}
export declare class DtoKurangBudgetDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoKurangBudgetDetail, EditableDtoKurangBudgetDetail, QDtoKurangBudgetDetail, DtoKurangBudgetDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class ApprovalService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Approval, EditableApproval, QApproval> {
    private _UserId?;
    private _SubUserId?;
    private _Feature?;
    ...
    private _MasterRole?;
    private _HeaderProjek?;
    private _PengajuanForm?;
    private _BudgetTransfer?;
    private _MasterUser?;
    private _TopUpBudget?;
    private _KurangBudget?;
    private _EstimasiVSRealisasi?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    UserId(): UserDtoService<ClientType>;
    SubUserId(): UserDtoService<ClientType>;
    Feature(): FeatureService<ClientType>;
    StepApproval(): StepApprovalService<ClientType>;
    MasterRole(): MasterRoleService<ClientType>;
    HeaderProjek(): HeaderProjekService<ClientType>;
    PengajuanForm(): PengajuanFormService<ClientType>;
    BudgetTransfer(): BudgetTransferService<ClientType>;
    MasterUser(): MasterUserService<ClientType>;
    TopUpBudget(): TopUpBudgetService<ClientType>;
    KurangBudget(): KurangBudgetService<ClientType>;
    EstimasiVSRealisasi(): EstimasiVSRealisasiService<ClientType>;
}
export declare class ApprovalCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Approval, EditableApproval, QApproval, ApprovalId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class FeatureService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Feature, EditableFeature, QFeature> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class FeatureCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Feature, EditableFeature, QFeature, FeatureId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class StepApprovalService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, StepApproval, EditableStepApproval, QStepApproval> {
    private _UserId?;
    private _SubUserId?;
    private _MasterRole?;
    private _ApprovalConfigCondition?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    UserId(): UserDtoService<ClientType>;
    SubUserId(): UserDtoService<ClientType>;
    MasterRole(): MasterRoleService<ClientType>;
    ApprovalConfigCondition(): ApprovalConfigConditionService<ClientType>;
}
export declare class StepApprovalCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, StepApproval, EditableStepApproval, QStepApproval, StepApprovalId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class ApprovalConfigConditionService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, ApprovalConfigCondition, EditableApprovalConfigCondition, QApprovalConfigCondition> {
    private _UserId?;
    private _ApprovalConfig?;
    private _MasterRole?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    UserId(): UserDtoService<ClientType>;
    ApprovalConfig(): ApprovalConfigService<ClientType>;
    MasterRole(): MasterRoleService<ClientType>;
    StepApproval(): StepApprovalCollectionService<ClientType>;
    StepApproval(id: StepApprovalId): StepApprovalService<ClientType>;
}
export declare class ApprovalConfigConditionCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, ApprovalConfigCondition, EditableApprovalConfigCondition, QApprovalConfigCondition, ApprovalConfigConditionId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class ApprovalConfigService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, ApprovalConfig, EditableApprovalConfig, QApprovalConfig> {
    private _Feature?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Feature(): FeatureService<ClientType>;
}
export declare class ApprovalConfigCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, ApprovalConfig, EditableApprovalConfig, QApprovalConfig, ApprovalConfigId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class HeaderProjekService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, HeaderProjek, EditableHeaderProjek, QHeaderProjek> {
    private _Status?;
    private _JenisProgram?;
    private _Region?;
    private _Brand?;
    private _Departmen?;
    private _MasterOrganization?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Status(): STATUS_ENUMService<ClientType>;
    JenisProgram(): JenisProgramService<ClientType>;
    Region(): RegionService<ClientType>;
    Brand(): BrandService<ClientType>;
    Departmen(): DepartmenService<ClientType>;
    MasterOrganization(): MasterOrganizationService<ClientType>;
    BudgetAlokasi(): BudgetAlokasiCollectionService<ClientType>;
    BudgetAlokasi(id: BudgetAlokasiId): BudgetAlokasiService<ClientType>;
    HeaderProjekBrand(): HeaderProjekBrandCollectionService<ClientType>;
    HeaderProjekBrand(id: HeaderProjekBrandId): HeaderProjekBrandService<ClientType>;
    HeaderProjekDepartemen(): HeaderProjekDepartemenCollectionService<ClientType>;
    HeaderProjekDepartemen(id: HeaderProjekDepartemenId): HeaderProjekDepartemenService<ClientType>;
    Approval(): ApprovalCollectionService<ClientType>;
    Approval(id: ApprovalId): ApprovalService<ClientType>;
}
export declare class HeaderProjekCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, HeaderProjek, EditableHeaderProjek, QHeaderProjek, HeaderProjekId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class JenisProgramService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, JenisProgram, EditableJenisProgram, QJenisProgram> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    KategoriPpl(): KategoriPplCollectionService<ClientType>;
    KategoriPpl(id: KategoriPplId): KategoriPplService<ClientType>;
}
export declare class JenisProgramCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, JenisProgram, EditableJenisProgram, QJenisProgram, JenisProgramId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class KategoriPplService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, KategoriPpl, EditableKategoriPpl, QKategoriPpl> {
    private _JenisProgram?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    JenisProgram(): JenisProgramService<ClientType>;
    JenisPpl(): JenisPplCollectionService<ClientType>;
    JenisPpl(id: JenisPplId): JenisPplService<ClientType>;
}
export declare class KategoriPplCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, KategoriPpl, EditableKategoriPpl, QKategoriPpl, KategoriPplId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class JenisPplService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, JenisPpl, EditableJenisPpl, QJenisPpl> {
    private _KodeKlaims?;
    private _KategoriPpl?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    KodeKlaims(): KodeKlaimsService<ClientType>;
    KategoriPpl(): KategoriPplService<ClientType>;
}
export declare class JenisPplCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, JenisPpl, EditableJenisPpl, QJenisPpl, JenisPplId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class KodeKlaimsService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, KodeKlaims, EditableKodeKlaims, QKodeKlaims> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterKlaim(): MasterKlaimCollectionService<ClientType>;
    MasterKlaim(id: MasterKlaimId): MasterKlaimService<ClientType>;
}
export declare class KodeKlaimsCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, KodeKlaims, EditableKodeKlaims, QKodeKlaims, KodeKlaimsId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class MasterKlaimService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, MasterKlaim, EditableMasterKlaim, QMasterKlaim> {
    private _KodeKlaims?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    KodeKlaims(): KodeKlaimsService<ClientType>;
    MasterKlaimSyarat(): MasterKlaimSyaratCollectionService<ClientType>;
    MasterKlaimSyarat(id: MasterKlaimSyaratId): MasterKlaimSyaratService<ClientType>;
}
export declare class MasterKlaimCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, MasterKlaim, EditableMasterKlaim, QMasterKlaim, MasterKlaimId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class MasterKlaimSyaratService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, MasterKlaimSyarat, EditableMasterKlaimSyarat, QMasterKlaimSyarat> {
    private _MasterKlaim?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterKlaim(): MasterKlaimService<ClientType>;
}
export declare class MasterKlaimSyaratCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, MasterKlaimSyarat, EditableMasterKlaimSyarat, QMasterKlaimSyarat, MasterKlaimSyaratId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class RegionService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Region, EditableRegion, QRegion> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Area(): AreaCollectionService<ClientType>;
    Area(id: AreaId): AreaService<ClientType>;
}
...
export declare class AreaService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Area, EditableArea, QArea> {
    private _Region?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Region(): RegionService<ClientType>;
    Distributor(): DistributorCollectionService<ClientType>;
    Distributor(id: DistributorId): DistributorService<ClientType>;
}
export declare class AreaCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Area, EditableArea, QArea, AreaId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DistributorService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Distributor, EditableDistributor, QDistributor> {
    private _Area?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Area(): AreaService<ClientType>;
}
export declare class DistributorCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Distributor, EditableDistributor, QDistributor, DistributorId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class BrandService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Brand, EditableBrand, QBrand> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    PostBudget(): PostBudgetCollectionService<ClientType>;
    PostBudget(id: PostBudgetId): PostBudgetService<ClientType>;
}
export declare class BrandCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Brand, EditableBrand, QBrand, BrandId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class PostBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, PostBudget, EditablePostBudget, QPostBudget> {
    private _Coa?;
    private _Departmen?;
    private _Brand?;
    private _Parent?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Coa(): CoaService<ClientType>;
    Departmen(): DepartmenService<ClientType>;
    Brand(): BrandService<ClientType>;
    Parent(): PostBudgetService<ClientType>;
    PostBudgetProgram(): PostBudgetProgramCollectionService<ClientType>;
    PostBudgetProgram(id: PostBudgetProgramId): PostBudgetProgramService<ClientType>;
}
export declare class PostBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, PostBudget, EditablePostBudget, QPostBudget, PostBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class CoaService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Coa, EditableCoa, QCoa> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    PostBudget(): PostBudgetCollectionService<ClientType>;
    PostBudget(id: PostBudgetId): PostBudgetService<ClientType>;
}
export declare class CoaCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Coa, EditableCoa, QCoa, CoaId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DepartmenService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Departmen, EditableDepartmen, QDepartmen> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DepartmenCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Departmen, EditableDepartmen, QDepartmen, DepartmenId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class PostBudgetProgramService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, PostBudgetProgram, EditablePostBudgetProgram, QPostBudgetProgram> {
    private _PostBudget?;
    private _JenisPpl?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    PostBudget(): PostBudgetService<ClientType>;
    JenisPpl(): JenisPplService<ClientType>;
}
export declare class PostBudgetProgramCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, PostBudgetProgram, EditablePostBudgetProgram, QPostBudgetProgram, PostBudgetProgramId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class BudgetAlokasiService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, BudgetAlokasi, EditableBudgetAlokasi, QBudgetAlokasi> {
    private _PostBudget?;
    private _JenisPpl?;
    private _SkenarioBudget?;
    private _HeaderProjek?;
    ...
    PostBudget(): PostBudgetService<ClientType>;
    JenisPpl(): JenisPplService<ClientType>;
    SkenarioBudget(): SkenarioBudgetService<ClientType>;
    HeaderProjek(): HeaderProjekService<ClientType>;
    BudgetAlokasiDetail(): BudgetAlokasiDetailCollectionService<ClientType>;
    BudgetAlokasiDetail(id: BudgetAlokasiDetailId): BudgetAlokasiDetailService<ClientType>;
}
export declare class BudgetAlokasiCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, BudgetAlokasi, EditableBudgetAlokasi, QBudgetAlokasi, BudgetAlokasiId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class SkenarioBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, SkenarioBudget, EditableSkenarioBudget, QSkenarioBudget> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class SkenarioBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, SkenarioBudget, EditableSkenarioBudget, QSkenarioBudget, SkenarioBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class BudgetAlokasiDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, BudgetAlokasiDetail, EditableBudgetAlokasiDetail, QBudgetAlokasiDetail> {
    private _BudgetAlokasi?;
    private _MasterBudget?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    BudgetAlokasi(): BudgetAlokasiService<ClientType>;
    MasterBudget(): MasterBudgetService<ClientType>;
}
export declare class BudgetAlokasiDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, BudgetAlokasiDetail, EditableBudgetAlokasiDetail, QBudgetAlokasiDetail, BudgetAlokasiDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class MasterBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, MasterBudget, EditableMasterBudget, QMasterBudget> {
    private _BudgetSap?;
    private _PostBudget?;
    private _Coa?;
    private _Brand?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    BudgetSap(): BudgetSapService<ClientType>;
    PostBudget(): PostBudgetService<ClientType>;
    Coa(): CoaService<ClientType>;
    Brand(): BrandService<ClientType>;
}
export declare class MasterBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, MasterBudget, EditableMasterBudget, QMasterBudget, MasterBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class BudgetSapService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, BudgetSap, EditableBudgetSap, QBudgetSap> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterBudget(): MasterBudgetCollectionService<ClientType>;
    MasterBudget(id: MasterBudgetId): MasterBudgetService<ClientType>;
}
export declare class BudgetSapCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, BudgetSap, EditableBudgetSap, QBudgetSap, BudgetSapId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class HeaderProjekBrandService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, HeaderProjekBrand, EditableHeaderProjekBrand, QHeaderProjekBrand> {
    private _Brand?;
    private _HeaderProjek?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Brand(): BrandService<ClientType>;
...
export declare class HeaderProjekBrandCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, HeaderProjekBrand, EditableHeaderProjekBrand, QHeaderProjekBrand, HeaderProjekBrandId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class HeaderProjekDepartemenService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, HeaderProjekDepartemen, EditableHeaderProjekDepartemen, QHeaderProjekDepartemen> {
    private _Departmen?;
    private _HeaderProjek?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Departmen(): DepartmenService<ClientType>;
...
export declare class HeaderProjekDepartemenCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, HeaderProjekDepartemen, EditableHeaderProjekDepartemen, QHeaderProjekDepartemen, HeaderProjekDepartemenId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class PengajuanFormService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, PengajuanForm, EditablePengajuanForm, QPengajuanForm> {
    private _Status?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Status(): STATUS_ENUMService<ClientType>;
    PengajuanFormOutlet(): PengajuanFormOutletCollectionService<ClientType>;
    PengajuanFormOutlet(id: PengajuanFormOutletId): PengajuanFormOutletService<ClientType>;
    PengajuanFormAttachment(): PengajuanFormAttachmentCollectionService<ClientType>;
    PengajuanFormAttachment(id: PengajuanFormAttachmentId): PengajuanFormAttachmentService<ClientType>;
    PengajuanFormProduk(): PengajuanFormProdukCollectionService<ClientType>;
    PengajuanFormProduk(id: PengajuanFormProdukId): PengajuanFormProdukService<ClientType>;
    PengajuanFormDetail(): PengajuanFormDetailCollectionService<ClientType>;
    PengajuanFormDetail(id: PengajuanFormDetailId): PengajuanFormDetailService<ClientType>;
    Approval(): ApprovalCollectionService<ClientType>;
    Approval(id: ApprovalId): ApprovalService<ClientType>;
}
export declare class PengajuanFormCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, PengajuanForm, EditablePengajuanForm, QPengajuanForm, PengajuanFormId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class PengajuanFormOutletService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, PengajuanFormOutlet, EditablePengajuanFormOutlet, QPengajuanFormOutlet> {
    private _Outlet?;
    private _PengajuanForm?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Outlet(): OutletService<ClientType>;
    PengajuanForm(): PengajuanFormService<ClientType>;
}
export declare class PengajuanFormOutletCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, PengajuanFormOutlet, EditablePengajuanFormOutlet, QPengajuanFormOutlet, PengajuanFormOutletId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class OutletService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Outlet, EditableOutlet, QOutlet> {
    private _Area?;
    private _OutletGroup?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Area(): AreaService<ClientType>;
    OutletGroup(): OutletGroupService<ClientType>;
}
export declare class OutletCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Outlet, EditableOutlet, QOutlet, OutletId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class OutletGroupService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, OutletGroup, EditableOutletGroup, QOutletGroup> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Outlet(): OutletCollectionService<ClientType>;
    Outlet(id: OutletId): OutletService<ClientType>;
}
export declare class OutletGroupCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, OutletGroup, EditableOutletGroup, QOutletGroup, OutletGroupId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class PengajuanFormAttachmentService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, PengajuanFormAttachment, EditablePengajuanFormAttachment, QPengajuanFormAttachment> {
    private _PengajuanForm?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    PengajuanForm(): PengajuanFormService<ClientType>;
}
export declare class PengajuanFormAttachmentCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, PengajuanFormAttachment, EditablePengajuanFormAttachment, QPengajuanFormAttachment, PengajuanFormAttachmentId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class PengajuanFormProdukService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, PengajuanFormProduk, EditablePengajuanFormProduk, QPengajuanFormProduk> {
    private _PengajuanForm?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    PengajuanForm(): PengajuanFormService<ClientType>;
}
export declare class PengajuanFormProdukCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, PengajuanFormProduk, EditablePengajuanFormProduk, QPengajuanFormProduk, PengajuanFormProdukId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class PengajuanFormDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, PengajuanFormDetail, EditablePengajuanFormDetail, QPengajuanFormDetail> {
    private _PengajuanForm?;
    private _PostBudget?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    PengajuanForm(): PengajuanFormService<ClientType>;
...
export declare class PengajuanFormDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, PengajuanFormDetail, EditablePengajuanFormDetail, QPengajuanFormDetail, PengajuanFormDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class BudgetTransferService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, BudgetTransfer, EditableBudgetTransfer, QBudgetTransfer> {
    private _Status?;
    private _Feature?;
    private _KurangBudget?;
    ...
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Status(): STATUS_ENUMService<ClientType>;
    BudgetTransferDetail(): BudgetTransferDetailCollectionService<ClientType>;
    BudgetTransferDetail(id: BudgetTransferDetailId): BudgetTransferDetailService<ClientType>;
    Approval(): ApprovalCollectionService<ClientType>;
    Approval(id: ApprovalId): ApprovalService<ClientType>;
    Feature(): FeatureService<ClientType>;
    KurangBudget(): KurangBudgetService<ClientType>;
    HeaderProjekSumber(): HeaderProjekService<ClientType>;
    HeaderProjekTujuan(): HeaderProjekService<ClientType>;
}
export declare class BudgetTransferCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, BudgetTransfer, EditableBudgetTransfer, QBudgetTransfer, BudgetTransferId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class BudgetTransferDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, BudgetTransferDetail, EditableBudgetTransferDetail, QBudgetTransferDetail> {
    private _BudgetTransfer?;
    ...
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    BudgetTransfer(): BudgetTransferService<ClientType>;
    BudgetAlokasiSumber(): BudgetAlokasiService<ClientType>;
    BudgetAlokasiTujuan(): BudgetAlokasiService<ClientType>;
    BudgetAlokasiDetailSumber(): BudgetAlokasiDetailService<ClientType>;
    BudgetAlokasiDetailTujuan(): BudgetAlokasiDetailService<ClientType>;
    SkenarioBudgetSumber(): SkenarioBudgetService<ClientType>;
    SkenarioBudgetTujuan(): SkenarioBudgetService<ClientType>;
    PostBudgetSumber(): PostBudgetService<ClientType>;
    PostBudgetTujuan(): PostBudgetService<ClientType>;
}
export declare class BudgetTransferDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, BudgetTransferDetail, EditableBudgetTransferDetail, QBudgetTransferDetail, BudgetTransferDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class KurangBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, KurangBudget, EditableKurangBudget, QKurangBudget> {
    private _Status?;
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Status(): STATUS_ENUMService<ClientType>;
    KurangBudgetDetail(): KurangBudgetDetailCollectionService<ClientType>;
    KurangBudgetDetail(id: KurangBudgetDetailId): KurangBudgetDetailService<ClientType>;
    MasterUser(): MasterUserService<ClientType>;
    Approval(): ApprovalCollectionService<ClientType>;
    Approval(id: ApprovalId): ApprovalService<ClientType>;
}
export declare class KurangBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, KurangBudget, EditableKurangBudget, QKurangBudget, KurangBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class KurangBudgetDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, KurangBudgetDetail, EditableKurangBudgetDetail, QKurangBudgetDetail> {
    private _KurangBudget?;
    private _BudgetAlokasi?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    KurangBudget(): KurangBudgetService<ClientType>;
...
export declare class KurangBudgetDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, KurangBudgetDetail, EditableKurangBudgetDetail, QKurangBudgetDetail, KurangBudgetDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class MasterUserService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, MasterUser, EditableMasterUser, QMasterUser> {
    private _Role?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Role(): MasterRoleService<ClientType>;
    UserDistributor(): UserDistributorCollectionService<ClientType>;
    UserDistributor(id: UserDistributorId): UserDistributorService<ClientType>;
    UserArea(): UserAreaCollectionService<ClientType>;
    UserArea(id: UserAreaId): UserAreaService<ClientType>;
    UsersAttachment(): UsersAttachmentCollectionService<ClientType>;
    UsersAttachment(id: UsersAttachmentId): UsersAttachmentService<ClientType>;
    UserBrand(): UserBrandCollectionService<ClientType>;
    UserBrand(id: UserBrandId): UserBrandService<ClientType>;
}
export declare class MasterUserCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, MasterUser, EditableMasterUser, QMasterUser, MasterUserId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class UserDistributorService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, UserDistributor, EditableUserDistributor, QUserDistributor> {
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterUser(): MasterUserService<ClientType>;
}
export declare class UserDistributorCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, UserDistributor, EditableUserDistributor, QUserDistributor, UserDistributorId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class UserAreaService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, UserArea, EditableUserArea, QUserArea> {
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterUser(): MasterUserService<ClientType>;
}
export declare class UserAreaCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, UserArea, EditableUserArea, QUserArea, UserAreaId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class UsersAttachmentService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, UsersAttachment, EditableUsersAttachment, QUsersAttachment> {
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterUser(): MasterUserService<ClientType>;
}
export declare class UsersAttachmentCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, UsersAttachment, EditableUsersAttachment, QUsersAttachment, UsersAttachmentId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class UserBrandService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, UserBrand, EditableUserBrand, QUserBrand> {
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterUser(): MasterUserService<ClientType>;
}
export declare class UserBrandCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, UserBrand, EditableUserBrand, QUserBrand, UserBrandId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class TopUpBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, TopUpBudget, EditableTopUpBudget, QTopUpBudget> {
    private _Status?;
    private _Brand?;
    private _Channel?;
    private _Departmen?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    Status(): STATUS_ENUMService<ClientType>;
    TopUpBudgetDetail(): TopUpBudgetDetailCollectionService<ClientType>;
    TopUpBudgetDetail(id: TopUpBudgetDetailId): TopUpBudgetDetailService<ClientType>;
    Approval(): ApprovalCollectionService<ClientType>;
    Approval(id: ApprovalId): ApprovalService<ClientType>;
    Brand(): BrandService<ClientType>;
    Channel(): ChannelService<ClientType>;
    Departmen(): DepartmenService<ClientType>;
}
export declare class TopUpBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, TopUpBudget, EditableTopUpBudget, QTopUpBudget, TopUpBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class TopUpBudgetDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, TopUpBudgetDetail, EditableTopUpBudgetDetail, QTopUpBudgetDetail> {
    private _TopUpBudget?;
    private _PostBudget?;
    private _BudgetSap?;
    private _MasterBudget?;
...
export declare class TopUpBudgetDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, TopUpBudgetDetail, EditableTopUpBudgetDetail, QTopUpBudgetDetail, TopUpBudgetDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class ChannelService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, Channel, EditableChannel, QChannel> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class ChannelCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, Channel, EditableChannel, QChannel, ChannelId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class EstimasiVSRealisasiService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, EstimasiVSRealisasi, EditableEstimasiVSRealisasi, QEstimasiVSRealisasi> {
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterUser(): MasterUserService<ClientType>;
    Approval(): ApprovalCollectionService<ClientType>;
...
export declare class EstimasiVSRealisasiCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, EstimasiVSRealisasi, EditableEstimasiVSRealisasi, QEstimasiVSRealisasi, EstimasiVSRealisasiId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class DTO_EstimasiVSRealisasiService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_EstimasiVSRealisasi, EditableDTO_EstimasiVSRealisasi, QDTO_EstimasiVSRealisasi> {
    private _MasterUser?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    MasterUser(): DTO_MasterUserService<ClientType>;
    Approval(): DTO_ApprovalCollectionService<ClientType>;
...
export declare class DTO_EstimasiVSRealisasiCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_EstimasiVSRealisasi, EditableDTO_EstimasiVSRealisasi, QDTO_EstimasiVSRealisasi, DTO_EstimasiVSRealisasiId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class DTO_BudgetTransferService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_BudgetTransfer, EditableDTO_BudgetTransfer, QDTO_BudgetTransfer> {
    ...
    HeaderProjekSumber(): DTO_HeaderProjekService<ClientType>;
    HeaderProjekTujuan(): DTO_HeaderProjekService<ClientType>;
    KurangBudget(): DtoKurangBudgetService<ClientType>;
}
...
export declare class DTO_HeaderProjekService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_HeaderProjek, EditableDTO_HeaderProjek, QDTO_HeaderProjek> {
    ...
    MasterOrganization(): DTO_MasterOrgService<ClientType>;
...
export declare class DtoProjectListService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoProjectList, EditableDtoProjectList, QDtoProjectList> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoProjectListCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoProjectList, EditableDtoProjectList, QDtoProjectList, DtoProjectListId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class DTO_MasterUserService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_MasterUser, EditableDTO_MasterUser, QDTO_MasterUser> {
    ...
    UserBrand(): DTO_UserBrandCollectionService<ClientType>;
    UserBrand(id: DTO_UserBrandId): DTO_UserBrandService<ClientType>;
...
export declare class DTO_PostBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_PostBudget, EditableDTO_PostBudget, QDTO_PostBudget> {
    ...
    Brand(): DTO_BrandService<ClientType>;
    PostBudgetProgram(): DTO_PostBudgetProgramCollectionService<ClientType>;
    PostBudgetProgram(id: DTO_PostBudgetProgramId): DTO_PostBudgetProgramService<ClientType>;
}
...
export declare class DTO_PostBudgetProgramService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_PostBudgetProgram, EditableDTO_PostBudgetProgram, QDTO_PostBudgetProgram> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_PostBudgetProgramCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_PostBudgetProgram, EditableDTO_PostBudgetProgram, QDTO_PostBudgetProgram, DTO_PostBudgetProgramId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class DTO_TopUpBudgetService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_TopUpBudget, EditableDTO_TopUpBudget, QDTO_TopUpBudget> {
    private _Brand?;
    private _Departmen?;
    private _Channel?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
    TopUpBudgetDetail(): DTO_TopUpBudgetDetailCollectionService<ClientType>;
    TopUpBudgetDetail(id: DTO_TopUpBudgetDetailId): DTO_TopUpBudgetDetailService<ClientType>;
    Approval(): ApprovalCollectionService<ClientType>;
    Approval(id: ApprovalId): ApprovalService<ClientType>;
    Brand(): DTO_BrandService<ClientType>;
    Departmen(): DTO_DepartmenService<ClientType>;
    Channel(): DTO_ChannelService<ClientType>;
}
export declare class DTO_TopUpBudgetCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_TopUpBudget, EditableDTO_TopUpBudget, QDTO_TopUpBudget, DTO_TopUpBudgetId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_TopUpBudgetDetailService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_TopUpBudgetDetail, EditableDTO_TopUpBudgetDetail, QDTO_TopUpBudgetDetail> {
    private _PostBudget?;
    private _BudgetSap?;
    private _MasterBudget?;
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
...
export declare class DTO_TopUpBudgetDetailCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_TopUpBudgetDetail, EditableDTO_TopUpBudgetDetail, QDTO_TopUpBudgetDetail, DTO_TopUpBudgetDetailId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class DTO_UserBrandService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DTO_UserBrand, EditableDTO_UserBrand, QDTO_UserBrand> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DTO_UserBrandCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DTO_UserBrand, EditableDTO_UserBrand, QDTO_UserBrand, DTO_UserBrandId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class DtoHistoryTransaksiEstimasiViewService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoHistoryTransaksiEstimasiView, EditableDtoHistoryTransaksiEstimasiView, QDtoHistoryTransaksiEstimasiView> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoHistoryTransaksiEstimasiViewCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoHistoryTransaksiEstimasiView, EditableDtoHistoryTransaksiEstimasiView, QDtoHistoryTransaksiEstimasiView, DtoHistoryTransaksiEstimasiViewId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoHistoryTransaksiRealiasasiViewService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoHistoryTransaksiRealiasasiView, EditableDtoHistoryTransaksiRealiasasiView, QDtoHistoryTransaksiRealiasasiView> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoHistoryTransaksiRealiasasiViewCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoHistoryTransaksiRealiasasiView, EditableDtoHistoryTransaksiRealiasasiView, QDtoHistoryTransaksiRealiasasiView, DtoHistoryTransaksiRealiasasiViewId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoMasterProdukService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, DtoMasterProduk, EditableDtoMasterProduk, QDtoMasterProduk> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
export declare class DtoMasterProdukCollectionService<in out ClientType extends ODataHttpClient> extends EntitySetServiceV4<ClientType, DtoMasterProduk, EditableDtoMasterProduk, QDtoMasterProduk, DtoMasterProdukId> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
...
export declare class STATUS_ENUMService<in out ClientType extends ODataHttpClient> extends EntityTypeServiceV4<ClientType, STATUS_ENUM, EditableSTATUS_ENUM, QSTATUS_ENUM> {
    constructor(client: ClientType, basePath: string, name: string, options?: ODataServiceOptionsInternal);
}
