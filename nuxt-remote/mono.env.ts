...
export const env = {
    default: {
        MONO_NUXT_REMOTE_API_BASE_URL: 'https://dev-ppl-project.phoenix-squad.eu.org',
        MONO_NUXT_REMOTE_ODATA_BASE_URL: 'https://dev-ppl-project.phoenix-squad.eu.org/odata',
    },
